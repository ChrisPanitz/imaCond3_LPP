...
importRatings <- read.csv(paste0(parentFolder,"/experimentData/imaCond3_allratings.txt"), sep="")
...
tempData <- read.csv(paste0(parentFolder, "/experimentData/erpData/", importRatings$vpcode[1], "_IMAKON03_Average_Akqu1_EKP_P9P10_S51.dat"), 
                     header = FALSE, sep = " ")
...
for (partI in 1:length(importRatings$vpcode)) {
  tempData <- read.csv(paste0(parentFolder, "/experimentData/erpData/", importRatings$vpcode[partI], "_IMAKON03_Average_Akqu1_EKP_P9P10_S51.dat"), 
                       header = FALSE, sep = " ")
  lppMatAV1[partI,] <- tempData[,chanInd]
  tempData <- read.csv(paste0(parentFolder, "/experimentData/erpData/", importRatings$vpcode[partI], "_IMAKON03_Average_Akqu1_EKP_P9P10_S52.dat"), 
                       header = FALSE, sep = " ")
  lppMatNEU1[partI,] <- tempData[,chanInd]
  tempData <- read.csv(paste0(parentFolder, "/experimentData/erpData/", importRatings$vpcode[partI], "_IMAKON03_Average_Akqu1_EKP_P9P10_S53.dat"), 
                       header = FALSE, sep = " ")
  lppMatMIN1[partI,] <- tempData[,chanInd]
  tempData <- read.csv(paste0(parentFolder, "/experimentData/erpData/", importRatings$vpcode[partI], "_IMAKON03_Average_Akqu2_EKP_P9P10_S51.dat"), 
                       header = FALSE, sep = " ")
  lppMatAV2[partI,] <- tempData[,chanInd]
  tempData <- read.csv(paste0(parentFolder, "/experimentData/erpData/", importRatings$vpcode[partI], "_IMAKON03_Average_Akqu2_EKP_P9P10_S52.dat"), 
                       header = FALSE, sep = " ")
  lppMatNEU2[partI,] <- tempData[,chanInd]
  tempData <- read.csv(paste0(parentFolder, "/experimentData/erpData/", importRatings$vpcode[partI], "_IMAKON03_Average_Akqu2_EKP_P9P10_S53.dat"), 
                       header = FALSE, sep = " ")
...
dataLPP <- data.frame(
  partCode = factor(importRatings$vpcode),
  partInd = factor(importRatings$partInd),
...
capture.output(print(anovaLPPIma), file = paste0(parentFolder, "/supplement/04s_LPP_ima_anovaFreq.doc"))
...
capture.output(print(anovaBFLPPIma), file = paste0(parentFolder, "/supplement/04s_LPP_ima_anovaBayes.doc"))

# quick & dirty graph of CS Type x Time ANOVA for LPP in imagery-based conditioning group
plotLPPIma <- ezPlot(
  data = dataLPPLong[dataLPPLong$usGroup == "ima",],
  dv = LPP,
  wid = partInd,
...
ggsave(plot = plotLPPIma, filename = paste0(parentFolder, "/supplement/04s_LPP_ima_plot.jpg"),
...
capture.output(tableLPPIma, file = paste0(parentFolder, "/supplement/04s_lpp_ima_tTable.doc"))
...
capture.output(print(anovaLPPReal), file = paste0(parentFolder, "/supplement/04s_lpp_real_anovaFreq.doc"))
...
capture.output(print(anovaBFLPPReal), file = paste0(parentFolder, "/supplement/04s_lpp_real_anovaBayes.doc"))
...
ggsave(plot = plotLPPReal, filename = paste0(parentFolder, "/supplement/04s_lpp_real_plot.jpg"),
       width = 10, height = 10, units = "cm")
...
capture.output(tableLPPReal, file = paste0(parentFolder, "/supplement/04s_lpp_real_tTable.doc"))
...
capture.output(print(anovaLPP), file = "Supplement/04s_lpp_both_anovaFreq.doc")
...
capture.output(print(anovaBFLPP), file = "Supplement/04s_lpp_both_anovaBayes.doc")

# quick & dirty graph of US Group x CS Type x Time ANOVA for LPP across groups
plotLPP <- ezPlot(
  data = dataLPPLong,
  dv = LPP,
  wid = partInd,
...
ggsave(plot = plotLPP, filename = "Supplement/04s_lpp_both_plot.jpg",
