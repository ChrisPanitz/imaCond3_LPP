...
importRatings <- read.csv("data/imaCond3_allratings.txt", sep="")
...
importSCR <- read.csv("data/imaCond3_scrmatrix_cs.txt", sep = "")
...
capture.output(print(anovaSCRIma), file = "Supplement/02s_scr_ima_anovaFreq.doc")
...
capture.output(print(anovaBFSCRIma), file = "Supplement/02s_scr_ima_anovaBayes.doc")

# quick & dirty graph of CS Type x Time ANOVA for SCR in imagery-based conditioning group
plotSCRIma <- ezPlot(
  data = dataSCRLong[dataSCRLong$usGroup == "ima",],
  dv = SCR,
  wid = partInd,
...
ggsave(plot = plotSCRIma, filename = "Supplement/02s_scr_ima_plot.jpg",
...
capture.output(tableSCRIma, file = "Supplement/02s_scr_ima_tTable.doc")
...
dataSCR_noNA <- dataSCR[!is.na(rowMeans(subset(dataSCR, select = Av_1stBl:Min_2ndBl))),]
...
anovaSCRReal <- ezANOVA(
  data = dataSCRLong_noNA[dataSCRLong_noNA$usGroup == "real",],
  dv = SCR,
  wid = partInd,
  within = .(CS,time),
  type = 3,
...
capture.output(print(anovaSCRReal), file = "Supplement/02s_scr_real_anovaFreq.doc")
...
capture.output(print(anovaBFSCRReal), file = "Supplement/02s_scr_real_anovaBayes.doc")

# quick & dirty graph of CS Type x Time ANOVA for SCR in classical conditioning group
plotSCRReal <- ezPlot(
  data = dataSCRLong_noNA[dataSCRLong_noNA$usGroup == "real",],
  dv = SCR,
  wid = partInd,
...
ggsave(plot = plotSCRReal, filename = "Supplement/02s_scr_real_plot.jpg",
       width = 10, height = 10, units = "cm")
...
scrRealAvNeu1stBl_d <- cohens_d(x = dataSCR$Av_1stBl[dataSCR$usGroup == "real"],
                           y = dataSCR$Neu_1stBl[dataSCR$usGroup == "real"],
                           paired = TRUE)
scrRealAvNeu1stBl_BF <- ttestBF(x = dataSCR_noNA$Av_1stBl[dataSCR_noNA$usGroup == "real"],
                           y = dataSCR_noNA$Neu_1stBl[dataSCR_noNA$usGroup == "real"],
                           nullInterval = c(0, Inf), paired = TRUE) # one-sided x > y
# CS+av vs CS-
...
scrRealAvMin1stBl_d <- cohens_d(x = dataSCR$Av_1stBl[dataSCR$usGroup == "real"],
                           y = dataSCR$Min_1stBl[dataSCR$usGroup == "real"],
                           paired = TRUE)
scrRealAvMin1stBl_BF <- ttestBF(x = dataSCR_noNA$Av_1stBl[dataSCR_noNA$usGroup == "real"],
                           y = dataSCR_noNA$Min_1stBl[dataSCR_noNA$usGroup == "real"],
                           nullInterval = c(0, Inf), paired = TRUE) # one-sided x > y
# CS+neu vs CS-
...
scrRealNeuMin1stBl_d <- cohens_d(x = dataSCR$Neu_1stBl[dataSCR$usGroup == "real"],
                            y = dataSCR$Min_1stBl[dataSCR$usGroup == "real"],
                            paired = TRUE)
scrRealNeuMin1stBl_BF <- ttestBF(x = dataSCR_noNA$Neu_1stBl[dataSCR_noNA$usGroup == "real"],
                            y = dataSCR_noNA$Min_1stBl[dataSCR_noNA$usGroup == "real"],
                            nullInterval = NULL, paired = TRUE) # two-sided
...
scrRealAvNeu2ndBl_d <- cohens_d(x = dataSCR$Av_2ndBl[dataSCR$usGroup == "real"],
                                y = dataSCR$Neu_2ndBl[dataSCR$usGroup == "real"],
                                paired = TRUE)
scrRealAvNeu2ndBl_BF <- ttestBF(x = dataSCR_noNA$Av_2ndBl[dataSCR_noNA$usGroup == "real"],
                                y = dataSCR_noNA$Neu_2ndBl[dataSCR_noNA$usGroup == "real"],
                                nullInterval = c(0, Inf), paired = TRUE) # one-sided x > y
# CS+av vs CS-
...
scrRealAvMin2ndBl_d <- cohens_d(x = dataSCR$Av_2ndBl[dataSCR$usGroup == "real"],
                                y = dataSCR$Min_2ndBl[dataSCR$usGroup == "real"],
                                paired = TRUE)
scrRealAvMin2ndBl_BF <- ttestBF(x = dataSCR_noNA$Av_2ndBl[dataSCR_noNA$usGroup == "real"],
                                y = dataSCR_noNA$Min_2ndBl[dataSCR_noNA$usGroup == "real"],
                                nullInterval = c(0, Inf), paired = TRUE) # one-sided x > y
# CS+neu vs CS-
...
scrRealNeuMin2ndBl_d <- cohens_d(x = dataSCR$Neu_2ndBl[dataSCR$usGroup == "real"],
                                 y = dataSCR$Min_2ndBl[dataSCR$usGroup == "real"],
                                 paired = TRUE)
scrRealNeuMin2ndBl_BF <- ttestBF(x = dataSCR_noNA$Neu_2ndBl[dataSCR_noNA$usGroup == "real"],
                                 y = dataSCR_noNA$Min_2ndBl[dataSCR_noNA$usGroup == "real"],
                                 nullInterval = NULL, paired = TRUE) # two-sided
...
capture.output(tableSCRReal, file = "Supplement/02s_scr_real_tTable.doc")
...
# frequentist CS x Time ANOVA on SCR across conditioning groups
anovaSCR <- ezANOVA(
...
capture.output(print(anovaSCR), file = "Supplement/02s_scr_both_anovaFreq.doc")
...
capture.output(print(anovaBFSCR), file = "Supplement/02s_scr_both_anovaBayes.doc")
...
ggsave(plot = plotSCR, filename = "Supplement/02s_scr_both_plot.jpg",
