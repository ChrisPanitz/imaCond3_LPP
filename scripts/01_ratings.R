...
# quick & dirty graph of group x CS ANOVA on fear ratings
ezPlot(
  data = dataFearLong[dataFearLong$time == "Post",],
  dv = fear,
  wid = partInd,
...
# quick & dirty graph of group x CS ANOVA on anger ratings
ezPlot(
  data = dataAngerLong[dataAngerLong$time == "Post",],
  dv = anger,
  wid = partInd,
...
# quick & dirty graph of group x CS ANOVA on disgust ratings
ezPlot(
  data = dataDisgustLong[dataDisgustLong$time == "Post",],
  dv = disgust,
  wid = partInd,
...
save_as_docx(tableUnpleas, path = paste0(pathname, "/tables/tableUnpleas_raw.docx"))
save_as_docx(tableArousal, path = paste0(pathname, "/tables/tableArousal_raw.docx"))
save_as_docx(tableAnger, path = paste0(pathname, "/tables/tableAnger_raw.docx"))
save_as_docx(tableDisgust, path = paste0(pathname, "/tables/tableDisgust_raw.docx"))
...
graphFear <- graphFear + theme(plot.margin = unit(c(5,5,5,5), "mm"))
